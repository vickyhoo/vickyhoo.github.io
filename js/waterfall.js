...
(function() {
  ...
  var demoContent = [
    {
      demo_link: 'https://parg.co/lsP',
      img_link: 'https://i.loli.net/2018/04/20/5ad9a2c762e34.png',
      code_link: 'https://github.com/vickyhoo/antd-input-password',
      title: 'antd-input-password',
      core_tech: 'React Ant-Design',
      description: "password input based on antd's Input."
    }
  ];
